...
/**
 * @author 0opslab
 * @date on 2016/6/2 0002.
 */
public class g_SequenceFlow extends ActivitiTest {


    /**部署流程定义（从inputStream）*/
    @Test
    public void deploymentProcessDefinition_inputStream(){
        String[] temp = new String[]{"flow/sequenceFlow.bpmn","flow/sequenceFlow.png"};
        workFlow.deployClasspathResource(temp);
    }
