...
@WebAppConfiguration
@ContextConfiguration(locations = {"classpath*:/spring/Spring-beans-for-JUnit.xml", "classpath*:/spring/applicationContext-mvc.xml"})
public abstract class SpringActionTest {
    ...
    public void setUp() {
        ...
        request.setCharacterEncoding(APP.ENCODING);
    ...
    public void info(ResultActions resultActions) {
        ...
        try {
            ...
            sbuf.append("contentType:" + contentType + APP.LINE_SEPARATOR);
            if (contentType != null && contentType.indexOf("application/json") != -1) {
                String json = response.getContentAsString();
                sbuf.append("json:" + json + APP.LINE_SEPARATOR);
            } else {
                ModelAndView modelAndView = mvcResult.getModelAndView();
                if (modelAndView != null) {
                    sbuf.append("viewName:" + modelAndView.getViewName() + APP.LINE_SEPARATOR);
                    String modelMap = JacksonUtil.toJSON(modelAndView.getModelMap());
                    sbuf.append("modelMap:" + modelMap + APP.LINE_SEPARATOR);
                }
