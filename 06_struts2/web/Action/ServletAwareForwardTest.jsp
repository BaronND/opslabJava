...
<title>测试ServletActionAwareTest</title>
</head>
<body>
	<%
		application.setAttribute("appName", "测试ServletActionAwareTest");
	...
	%>
	<jsp:forward page="../action/ServletActionAwareTest.action"></jsp:forward>
