...
<script type="text/javascript">
    ...
    function onClieckDeptItem(event, treeId, treeName) {
        ...
        //初始化部门信息
        $('#table').datagrid({
            url: '${contextPath}/admin/dept/info?id=' + treeName.id,
            columns: [[
        ...
        //初始化部门人员信息
        $("#userlist").datagrid({
            url: '${contextPath}/admin/dept/userlist.do?deptId=' + treeName.id,
            title: '部门人员',
            columns: [[
                {field: 'id', title: 'id', width: '20%'},
     ...
     */
    function initList() {
        $.getJSON("${contextPath}/admin/dept/json.do", function (data) {
